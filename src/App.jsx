...
function App() {
  return (
    <div className="App min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-200 relative">
      ...
      />
      <div className="w-full max-w-md p-8 bg-white/90 backdrop-blur-sm rounded-xl shadow-lg space-y-4 transition-all duration-300 hover:shadow-xl hover:scale-102 relative z-10">
        <BarcodeScanner />
      </div>
    </div>
  );
